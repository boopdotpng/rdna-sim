...
def main() -> None:
  ...
  handwritten_total = sum(lines for lines, _ in rows)
  print(f"{handwritten_total} lines in {len(rows)} files (skipped {skipped} autogenerated)")
  print()
  total_lines = handwritten_total + rust_generated
