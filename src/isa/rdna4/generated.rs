...
pub static ARCH_COMMON_DEFS: &[InstructionCommonDef] = &[
  ...
  InstructionCommonDef {
    name: "s_alloc_vgpr",
    args: &[ArgSpec { kind: ArgKind::Sgpr, data_type: DataType::None, width: 32 }],
  ...
  InstructionCommonDef {
    ...
    args: &[
          ArgSpec { kind: ArgKind::Vgpr, data_type: DataType::None, width: 64 },
          ArgSpec { kind: ArgKind::RegOrImm, data_type: DataType::Unknown, width: 16 },
        ],
  ...
  InstructionCommonDef {
    ...
    args: &[
          ArgSpec { kind: ArgKind::Vgpr, data_type: DataType::None, width: 32 },
          ArgSpec { kind: ArgKind::RegOrImm, data_type: DataType::Unknown, width: 32 },
          ArgSpec { kind: ArgKind::RegOrImm, data_type: DataType::Unknown, width: 32 },
          ArgSpec { kind: ArgKind::RegOrImm, data_type: DataType::F32, width: 32 },
        ],
  ...
  InstructionCommonDef {
    ...
    encodings: &["VOPDXY", "VOPDXY_INST_LITERAL"],
  },
  InstructionCommonDef {
  ...
  InstructionCommonDef {
    ...
    encodings: &["ENC_VOP1", "ENC_VOP3", "VOP1_VOP_DPP16", "VOP1_VOP_DPP8", "VOP3_VOP_DPP16", "VOP3_VOP_DPP8"],
  },
  InstructionCommonDef {
  ...
  InstructionCommonDef {
    ...
    args: &[
          ...
          ArgSpec { kind: ArgKind::Vgpr, data_type: DataType::None, width: 128 },
          ArgSpec { kind: ArgKind::Vgpr, data_type: DataType::None, width: 128 },
          ArgSpec { kind: ArgKind::RegOrImm, data_type: DataType::Unknown, width: 128 },
        ],
    encodings: &["ENC_VOP3P"],
  },
  InstructionCommonDef {
...
pub static INSTRUCTION_DEFS: &[InstructionDef<Instruction>] = &[
  ...
  InstructionDef {
    instruction: Instruction::DsMaxNumF64,
  ...
  InstructionDef {
    instruction: Instruction::DsMaxNumRtnF64,
  ...
  InstructionDef {
    instruction: Instruction::DsMinNumF64,
  ...
  InstructionDef {
    instruction: Instruction::DsMinNumRtnF64,
  ...
  InstructionDef {
    instruction: Instruction::VMaxNumF64,
  ...
  InstructionDef {
    instruction: Instruction::VMaximumF64,
  ...
  InstructionDef {
    instruction: Instruction::VMinNumF64,
  ...
  InstructionDef {
    instruction: Instruction::VMinimumF64,
...
pub static INSTRUCTION_BY_NAME: &[(&str, Instruction)] = &[
  ...
  ("ds_max_num_f64", Instruction::DsMaxNumF64),
  ("ds_max_num_rtn_f32", Instruction::DsMaxNumRtnF32),
  ("ds_max_num_rtn_f64", Instruction::DsMaxNumRtnF64),
  ...
  ("ds_min_num_f64", Instruction::DsMinNumF64),
  ("ds_min_num_rtn_f32", Instruction::DsMinNumRtnF32),
  ("ds_min_num_rtn_f64", Instruction::DsMinNumRtnF64),
  ...
  ("v_max_num_f64", Instruction::VMaxNumF64),
  ...
  ("v_maximum_f64", Instruction::VMaximumF64),
  ...
  ("v_min_num_f64", Instruction::VMinNumF64),
  ...
  ("v_minimum_f64", Instruction::VMinimumF64),
